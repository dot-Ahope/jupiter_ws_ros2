#!/usr/bin/env python3
"""
Nav2 Navigation Launch for Jupiter
SLAM Toolbox와 함께 사용 - 실시간 맵 생성하면서 자율 주행

사용법:
  터미널 1: ros2 launch sllidar_ros2 jupiter_full_system.launch.py
  터미널 2: ros2 launch sllidar_ros2 nav2_navigation.launch.py
"""
