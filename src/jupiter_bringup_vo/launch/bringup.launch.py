...
def generate_launch_description():
    pkg_prefix = FindPackageShare('jupiter_bringup_vo')
    ...
    visual_odom_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([pkg_prefix, '/launch/visual_odom.launch.py'])
    )
    ...
    return LaunchDescription([
        ...
        visual_odom_launch     # Visual Odometry 추가
    ])
