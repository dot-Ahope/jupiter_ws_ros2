...
def generate_launch_description():
    ...
    # Velodyne VLP-16 Launch
    # Includes driver, pointcloud, and laserscan nodes
    ...
    velodyne_transform_node = Node(
        ...
        parameters=[{
            ...
            'model': 'VLP16',
            'min_range': 0.4, # Decreased from 0.9 to see closer objects
            'max_range': 130.0,
